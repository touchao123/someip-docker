...
public:
    ...
    void on_message(const std::shared_ptr<vsomeip::message> &_response) {
        ...
        v2x_demo_msg.ParseFromArray(its_payload->get_data(),its_payload->get_length());
        std::cout <<"v2x_demo_msg.id:"<< v2x_demo_msg.id()<< std::endl;
        std::cout <<"v2x_demo_msg.velocity:"<< v2x_demo_msg.velocity()<< std::endl;
        std::cout <<"v2x_demo_msg.acc:"<< v2x_demo_msg.acc()<< std::endl;
        std::cout <<"v2x_demo_msg.timestamp:"<< v2x_demo_msg.timestamp()<< std::endl;
        std::cout <<"delt tp:"<< millisec - v2x_demo_msg.timestamp()<< std::endl;
